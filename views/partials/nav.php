<nav class="bg-gray-800/50">
    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
            ...
            <a href="/about.php" class="<?= urlIs('/about.php')? "rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white":"rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white" ?>">About</a>
            <a href="/contact.php" class="<?= urlIs('/contact.php')? "rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white":"rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white" ?>">Contact</a>
            </div>
        </div>
        </div>
        <div class="hidden md:block">
